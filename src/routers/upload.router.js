...
router.get("/filesbyid/:id",[jwtHandling.jwtVerify , userGuard],uploadController.getFileById)
router.get('/file/join/allbyid/:id',[jwtHandling.jwtVerify , userGuard],joinedFilesController.getJoinedFilesById)
router.get('/files/getall/:userId?',[jwtHandling.jwtVerify , userGuard],uploadController.getUserSingleFiles)
router.delete("/join/file/delete/:id",[jwtHandling.jwtVerify , userGuard],joinedFilesController.deleteJoinedFileFromDB)
router.get('/download/file/:id',[jwtHandling.jwtVerify , userGuard],uploadController.downloadFileById)
router.get('/files/joined/getall/:userId?',[jwtHandling.jwtVerify , userGuard],joinedFilesController.getUserJoinedFiles)
router.get('/files/joined/getbyid/:id',[jwtHandling.jwtVerify , userGuard],joinedFilesController.downloadJoinedFileById)
